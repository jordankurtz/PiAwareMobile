...
class AircraftListScreenTest {
    ...
    @Test
    fun listHeaderDisplaysTrackedLabel() = runComposeUiTest {
        setContent {
    ...
    @Test
    fun listHeaderDisplaysTitle() = runComposeUiTest {
        setContent {
            ListHeader(aircraft = testAircraft)
        }
    ...
    @Test
    fun tabletListPanelShowsAircraftItems() = runComposeUiTest {
        setContent {
    ...
    @Test
    fun tabletListPanelShowsAircraftType() = runComposeUiTest {
        setContent {
            TabletAircraftListPanel(
                aircraft = testAircraft,
                selectedHex = null,
    ...
    @Test
    fun tabletListPanelFiresSelectionCallback() = runComposeUiTest {
    ...
    @Test
    fun tabletListPanelShowsDetailsWhenSelected() = runComposeUiTest {
        setContent {
            TabletAircraftListPanel(
                aircraft = testAircraft,
                selectedHex = "A1B2C3",
    ...
    @Test
    fun tabletDetailsShowsBackButton() = runComposeUiTest {
        var closed = false
        setContent {
    ...
    @Test
    fun tabletDetailsShowsServerInfo() = runComposeUiTest {
        setContent {
            TabletAircraftDetails(
                aircraftWithServers = testAircraft[0],
                flightDetails = Async.NotStarted,
    ...
    @Test
    fun flightInfoDisplaysRouteInfo() = runComposeUiTest {
        setContent {
    ...
    @Test
    fun flightInfoDisplaysAircraftType() = runComposeUiTest {
        setContent {
            FlightInfo(flight = mockFlight())
        }
        onNodeWithText("A320").assertIsDisplayed()
    ...
    @Test
    fun flightInfoDisplaysProgress() = runComposeUiTest {
        setContent {
            FlightInfo(flight = mockFlight())
        }
    ...
    @Test
    fun flightDetailsSectionShowsLoadingState() = runComposeUiTest {
        setContent {
    ...
    @Test
    fun flightDetailsSectionShowsErrorWithRetry() = runComposeUiTest {
        var retried = false
        setContent {
            FlightDetailsSection(
                aircraft = mockAircraft(flight = "TST101"),
    ...
    @Test
    fun flightDetailsSectionShowsOpenInFlightAware() = runComposeUiTest {
        var opened = false
        setContent {
            FlightDetailsSection(
                aircraft = mockAircraft(flight = "TST101"),
    ...
    @Test
    fun flightDetailsSectionHidesFlightAwareWhenNoFlight() = runComposeUiTest {
        setContent {
            FlightDetailsSection(

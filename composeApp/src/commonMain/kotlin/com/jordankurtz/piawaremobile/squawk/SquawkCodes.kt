        ...
        mapOf(
            ...
            "7001"
                ...
                SquawkInfo(
                    ...
                    description = "Military low-level training flight (regional assignment; common in UK/Europe).",
                    severity = SquawkSeverity.INFO,
                ),
            "7002"
                to
                SquawkInfo(
                    name = "Military Low Level (Formation)",
                    description = "Military low-level formation training flight.",
                    severity = SquawkSeverity.INFO,
                ),
            "7004"
                to

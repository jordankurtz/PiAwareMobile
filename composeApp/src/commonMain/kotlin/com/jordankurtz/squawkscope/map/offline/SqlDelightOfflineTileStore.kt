...
import com.jordankurtz.squawkscope.map.cache.Offline_region
import com.jordankurtz.squawkscope.map.cache.TileCacheQueries
        ...
        withContext(ioDispatcher) {
            queries.transactionWithResult {
                queries.insertOfflineRegion(
                    ...
                    url_template = region.urlTemplate,

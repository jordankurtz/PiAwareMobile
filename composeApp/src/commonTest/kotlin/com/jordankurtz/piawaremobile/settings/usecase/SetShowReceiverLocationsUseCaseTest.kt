...
class SetShowReceiverLocationsUseCaseTest {
    ...
    @Test
    fun `invoke with true should save settings with showReceiverLocations as true`() = runTest {
        // Given
    ...
    @Test
    fun `invoke with false should save settings with showReceiverLocations as false`() = runTest {
        // Given
        val initialSettings = Settings(
            servers = emptyList(),
            refreshInterval = 5,

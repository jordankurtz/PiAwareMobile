...
class SetCenterMapOnUserOnStartUseCaseTest {
    ...
    @Test
    fun `invoke with true should save settings with centerMapOnUserOnStart as true`() =
    ...
    @Test
    fun `invoke with false should save settings with centerMapOnUserOnStart as false`() =
        runTest(testDispatcher) {
            // Given
            val initialSettings =
                Settings(
